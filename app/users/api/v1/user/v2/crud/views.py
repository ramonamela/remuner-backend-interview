...
from app.users.api.v1.user.v2.crud.view_models import (
    UserCrudIdOutputV2,
    UserCrudInputV2,
)
from app.users.dependency_injection.domain.controllers.v1.user.crud import (
...
async def users_post_v2(post_input: UserCrudInputV2) -> UserCrudIdOutputV2:
